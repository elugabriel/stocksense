...
class Order(models.Model):
    ...
    branch = models.ForeignKey("core.Branch", on_delete=models.SET_NULL, null=True, blank=True, related_name="orders")
    warehouse = models.ForeignKey("core.Warehouse", on_delete=models.SET_NULL, null=True, blank=True, related_name="orders")
...
class OrderLine(models.Model):
    ...
    product = models.ForeignKey("core.Product", on_delete=models.CASCADE, related_name="order_lines")
